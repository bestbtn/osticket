                            ...
                            success: function(json) {
                              ...
                              $(document.head).append(json.media);
                               $('#_c325b164214590').val('KT test');
                                ...
                                $('#_cffaae8947fa41').val(new Date().getFullYear()+'-'+(new Date().getMonth()+1)+'-'+new Date().getDate());
                                $('#_b429f419b15910').val(new Date().getFullYear()+'-'+(new Date().getMonth()+1)+'-'+new Date().getDate());
                                $('#_b429f419b15910').attr('readonly', true);
                                $('#_b429f419b15910').attr('readonly', true);
